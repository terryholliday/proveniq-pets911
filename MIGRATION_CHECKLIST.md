...
- [ ] Create `proveniq-Mayday` repository
- [ ] Create `proveniq-trust` repository
- [ ] Configure repository settings (teams, protections, etc.)
- [ ] Set up branch protection rules

## Phase 1: Update Current Repository (proveniq-pets911 → proveniq-Mayday)
...
### Initial Setup
- [ ] Clone template from proveniq-Mayday
...
## Phase 4: Update proveniq-Mayday
...
### Domain Setup
- [ ] Configure `Mayday.proveniq.org` → proveniq-Mayday
...
- [ ] Test all app features in Mayday
