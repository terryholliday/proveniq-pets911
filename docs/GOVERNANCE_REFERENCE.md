...
The following documents are canonical and MUST be consulted for any questions
regarding IP ownership, licensing, or permitted use:

- Trust IP Schedule
- Trust → Foundation $0 License
- Foundation → Shelter $0 License
- PetNexus Governance Canon
- Brand & Naming Canon
- Domain Strategy
...
```
proveniq-foundation/governance/
```
...
It MAY:
- Implement features defined by PetNexus governance
