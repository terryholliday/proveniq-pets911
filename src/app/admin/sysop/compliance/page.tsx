...
const COUNTY_DATA = [
  ...
  { county: 'Pendleton', agency: 'Sheriff / Warden', facility: 'County Shelter', notes: 'Defaults to State Code', harboring: '5-day', PetMaydayScore: 'D', phone: '(304) 358-2214', email: '', address: 'Franklin, WV 26807' },
  ...
  { county: 'Taylor', agency: 'Sheriff / Warden', facility: 'County Shelter', notes: 'Defaults to State Code', harboring: '5-day', PetMaydayScore: 'D', phone: '(304) 265-3365', email: '', address: 'Grafton, WV 26354' },
...
export default function CompliancePage() {
  ...
  const filteredCounties = COUNTY_DATA.filter(c => {
    ...
    if (filterScore && c.PetMaydayScore !== filterScore) return false;
    return true;
  });
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="border-b border-zinc-800 bg-zinc-900/50">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          <p className="text-zinc-400 text-sm">WV Animal Control Laws, Shelter Directory & PetMayday Standards</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-green-900/20 border border-green-800/50 rounded-lg p-4">
                  ...
                  <div className="text-sm text-zinc-400 mt-1">
                    ...
                    Combined with mandatory spay/neuter, Mercer leads in PetMayday compliance.
                  </div>
                </div>
                  ...
                  {filteredCounties.map(county => (
                    <tr key={county.county} className="hover:bg-zinc-900/50">
                      ...
                      <td className="px-3 py-3 text-center">
                        <span className={`text-xs font-bold px-2 py-1 rounded ${SCORE_COLORS[county.PetMaydayScore]}`}>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-2">
                {COUNTY_DATA.filter(c => c.PetMaydayScore === 'D').map(county => (
            ...
            {/* What PetMayday Can Do */}
            <div className="bg-green-900/20 border border-green-800 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-green-400 mb-3">✅ How PetMayday Addresses Dead Zones</h3>
        ...
        {activeTab === 'reform' && (
          <div className="space-y-6">
            ...
            {/* PetMayday Alignment */}
            <div className="bg-amber-900/20 border border-amber-800 rounded-lg p-5">
              <h3 className="font-semibold text-amber-300">🚨 PetMayday Alignment</h3>
              <p className="text-sm text-zinc-300 mt-2">
                The B.A.R.K. Act's digital transparency requirements mirror PetMayday's existing infrastructure:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4 text-xs">
                <div className="bg-zinc-900/50 rounded p-3">
                  <div className="text-amber-400 font-medium">§19-36-48</div>
                  <div className="text-zinc-400">24hr digital posting → PetMayday already does this</div>
                </div>
                <div className="bg-zinc-900/50 rounded p-3">
                  <div className="text-amber-400 font-medium">§19-36-48</div>
                  <div className="text-zinc-400">Statewide database → PetMayday provides this</div>
                </div>
                <div className="bg-zinc-900/50 rounded p-3">
                  <div className="text-amber-400 font-medium">§19-36-49</div>
                  <div className="text-zinc-400">Finder safe harbor → PetMayday empowers finders</div>
                </div>
              </div>
              <p className="text-sm text-zinc-400 mt-4">
                Shelters using PetMayday will automatically meet B.A.R.K. Act digital compliance requirements.
              </p>
            </div>
