    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 mt-1">Send alerts and manage messages</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-8 text-center">
          ...
          <h2 className="text-xl font-semibold mb-2">Communications Center</h2>
          <p className="text-zinc-400 mb-4">
            This section will include: Mass alerts, volunteer messaging, announcement broadcasts, 
