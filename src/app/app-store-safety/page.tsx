      ...
      <section className="px-6 py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-slate-200 leading-relaxed">
            <p>
              Pets 911 provides emotional support and general guidance related to pets during stressful situations such as loss, emergencies, or uncertainty.
            </p>
            ...
            <div className="p-5 rounded-xl bg-slate-950 border border-red-900/40">
              ...
              <ul className="space-y-2">
                <li>• Pets 911 does <strong>not</strong> provide medical, veterinary, or mental health diagnoses.</li>
                <li>• Pets 911 does <strong>not</strong> replace licensed professionals or emergency services.</li>
            ...
            <div>
              ...
              <p className="mt-2">
                Pets 911 may encourage users to seek professional help when appropriate.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Pets 911 is intended as a <strong>supportive informational tool</strong> only. Always consult qualified professionals for medical or mental health concerns.
              </p>
            </div>
