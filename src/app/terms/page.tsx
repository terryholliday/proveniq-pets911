      ...
      <section className="px-6 py-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-slate-200 leading-relaxed">
            <p>
              <strong>Pets 911 – Terms of Service (Safety & Use)</strong>
            </p>
            <div className="space-y-6">
              <div>
                <h2 className="text-xl font-bold text-white mb-2">Purpose of the Service</h2>
                <p>
                  Pets 911 is an informational and emotional support service designed to assist users during stressful situations involving pets, including loss, emergencies, and uncertainty.
                </p>
                <p className="mt-2">
                  Pets 911 does <strong>not</strong> provide medical, veterinary, psychological, or legal advice.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Pets 911 is <strong>not a replacement</strong> for:
                </p>
              ...
              <div>
                ...
                <p>
                  Pets 911 may encourage users to seek immediate professional or emergency assistance when a situation appears to involve serious risk or distress.
                </p>
                <p className="mt-2">
                  Pets 911 does not monitor users in real time and cannot guarantee detection of emergencies or crises.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Pets 911 is provided "as is." We make no guarantees regarding:
                </p>
                <ul className="list-disc pl-6 space-y-1 mt-2">
                  <li>Accuracy</li>
                  <li>Completeness</li>
              ...
              <div>
                ...
                <p>
                  To the maximum extent permitted by law, Pets 911 and its operators are not liable for any damages resulting from reliance on information provided through the service.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  Pets 911 is a support tool, not a decision-maker.
                </p>
              </div>
              ...
              <div>
                ...
                <p>
                  Pets 911 was created to support people during difficult moments. Nothing in these terms is intended to minimize grief or emotional pain.
                </p>
              </div>
            </div>
          </div>
